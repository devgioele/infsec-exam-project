...
public class ConciseHttpClient {
	...
	private String sendRequest(HttpRequest request) throws IOException {
		...
		throw new HttpException(request.uri().toString(), request.method(), response.statusCode(), body);
	}

	private HttpRequest.Builder compileRequest(String path, String jwt, Map<String, String> params) {
	...
	public String get(String path, String jwt) throws IOException {
	...
	public String post(String path, String jwt) throws IOException {
