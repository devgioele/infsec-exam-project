...
CREATE TABLE email (sender nvarchar(50) NOT NULL, receiver nvarchar(50) NOT NULL, signature text, subject ntext NULL, body ntext NOT NULL, [time] datetime2(3) NOT NULL, CONSTRAINT email_FK FOREIGN KEY (sender) REFERENCES [user] (email), CONSTRAINT email_FK_1 FOREIGN KEY (receiver) REFERENCES [user](email));
